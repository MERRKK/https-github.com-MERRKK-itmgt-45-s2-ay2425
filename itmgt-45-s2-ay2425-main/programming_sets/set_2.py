...
def shift_letter(letter, shift):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    #Formula Declaration
    current_position = ord(letter) - ord('A') # ord converts Unicode input into integer values
...
def caesar_cipher(message, shift):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    result = ""
    #Determine for position of letter and will add the shift in the later formula
    for char in message:
        if char.isalpha(): 
...
def scytale_cipher(message, shift):
    ...
    #calculate length number of the message
...
def scytale_decipher(message, shift):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
     ...
     # Calculate the number of rows based on the shift
    rows = shift
