...
# formula input
    ...
    #ensures that money will not show negative amount but instead 0
    remaining_money = max(0, math.floor(remaining_money))
#Output
...
#Formula
    interest_amount = principal * rate * periods #round down values using int function
    final_amount = int(principal + interest_amount) #calculating final amount by subtracting interest amount
#Output
    return final_amount
